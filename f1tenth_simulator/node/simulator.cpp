...
private:
    ...
    std::string map_frame, base_frame, scan_frame, racecar_frame;
...
public:
    ...
    RacecarSimulator(): im_server("racecar_sim") {
        ...
        n.getParam("racecar_frame",racecar_frame);
    ...
    void clear_obstacles(const visualization_msgs::InteractiveMarkerFeedbackConstPtr &feedback) {
        ...
        void pub_pose_transform(ros::Time timestamp) {
            ...
            ts.child_frame_id = racecar_frame+"/"+ base_frame;
        ...
        void pub_steer_ang_transform(ros::Time timestamp) {
            ...
            ts_wheel.header.frame_id = racecar_frame+"/"+  "front_left_hinge";
            ts_wheel.child_frame_id = racecar_frame+"/"+ "front_left_wheel";
            br.sendTransform(ts_wheel);
            ts_wheel.header.frame_id = racecar_frame+"/"+ "front_right_hinge";
            ts_wheel.child_frame_id = racecar_frame+"/"+ "front_right_wheel";
            br.sendTransform(ts_wheel);
        ...
        void pub_laser_link_transform(ros::Time timestamp) {
            ...
            scan_ts.header.frame_id = racecar_frame+"/"+base_frame;
        ...
        void pub_odom(ros::Time timestamp) {
            ...
            odom.child_frame_id = racecar_frame+"/"+base_frame;
